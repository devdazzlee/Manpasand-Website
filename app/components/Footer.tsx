        ...
        <div className="container mx-auto px-4 py-10 sm:py-12">
          ...
          <div className="border-t border-white/10 pt-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <p className="text-gray-300 text-xs sm:text-sm">
              © 2026 Manpasand Store. All rights reserved.
            </p>
            <div className="flex gap-5 text-xs sm:text-sm text-gray-300">
              <Link href="/privacy-policy" className="hover:text-white transition-colors py-1 min-h-11 inline-flex items-center">
                Privacy
              </Link>
              <Link href="/terms-conditions" className="hover:text-white transition-colors py-1 min-h-11 inline-flex items-center">
                Terms
              </Link>
            </div>
          </div>
