...
export default function WholesalePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Thank you! We will contact you soon regarding your wholesale inquiry.');
  };
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/90">
              Get special pricing for bulk orders. Contact us for wholesale inquiries.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-[#0D2B3A] font-medium mb-2">Estimated Quantity</label>
                <input
                  type="text"
